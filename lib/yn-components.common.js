...
var map = {
	...
	"./l-arrow-down-line.svg": "3f52",
	"./l-arrow-up-line.svg": "9dd0",
	"./radio-off.svg": "0209",
	"./radio-on.svg": "1276b",
	"./search.svg": "7461"
};
...
var getConfig = function getConfig(props) {
  return Object({"NODE_ENV":"production","VUE_APP_PREFIX":"yn","VUE_APP_VERSION":"0.6.7","BASE_URL":"/youdefine-UI/"})[props] || "";
};
  ...
  methods: {
    ...
    handleButtonClick: function handleButtonClick(e) {
      ...
      if (beforeClose && typeof beforeClose === "function") {
        var promise = beforeClose(e, this.status);
    ...
    handleBeforeLeave: function handleBeforeLeave() {
      this.beforeClose && typeof this.beforeClose === "function" && this.beforeClose(this.action, this.status);
...
/* harmony default export */ var src_dialog = (_objectSpread2({
  alert: function alert() {
    ...
    instance.message = args.message; // instance.callback = args.beforeClose;
...
var components = [src_action_sheet, src_button, src_calendar, src_checkbox, src_city_picker, src_counter, src_date_picker, src_dialog, src_dropdown_menu, src_dropdown_menu_item, src_field, src_field_group, src_flex, src_flex_item, src_iconfont, src_indicator, src_layout, src_picker, src_picky_stepper, src_popup, src_pull_refresh, src_radiobox, src_slider, src_spin, src_sticky, src_submit_action, src_submit_action_popup_content, src_submit_action_value, src_swipe, src_swipe_item, src_tab_item, src_tabs, src_toast];
