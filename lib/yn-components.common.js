...
var getConfig = function getConfig(props) {
  return Object({"NODE_ENV":"production","VUE_APP_PREFIX":"yn","VUE_APP_VERSION":"1.8.0","BASE_URL":"/youdefine-UI/"})[props] || "";
};
...
/* harmony default export */ var animation_list = (component_defineComponent({
  ...
  methods: {
    ...
    handleEnter: function handleEnter(el, done) {
      ...
      var delay = el.getAttribute("dataindex") * 5 + 100;
      setTimeout(function () {
        el.setAttribute("style", "\n          transition: opacity ".concat(_this.duration, "ms;\n          opacity: 1;\n          animation: ").concat(_this.animationType, "-one-by-one ").concat(_this.duration, "ms infinite;\n          animation-iteration-count: 1;\n        "));
        done();
      }, delay);
    },
  ...
  methods: {
    ...
    createDynamicContent: function createDynamicContent(h) {
      if (this.limited) {
        ...
        }, [this.createTitle(h), this.createClose(h), this.creteInputSearchArea(h)]), h(component_genComponentName("flex-item"), {
          directives: [{
            name: "show",
            value: !this.isSearching
          }],
