...
var getConfig = function getConfig(props) {
  return Object({"NODE_ENV":"production","VUE_APP_PREFIX":"yn","VUE_APP_VERSION":"0.7.14","BASE_URL":"/youdefine-UI/"})[props] || "";
};
 ...
 * @Last Modified by:   Just be free
 * @Last Modified time: 2020-11-16 14:34:43
 * @E-mail: justbefree@126.com
 */
...
/* harmony default export */ var animation_list_item = (component_defineComponent({
  ...
  render: function render(h) {
    return h("transition", {
      ...
      directives: [{
        name: "show",
        value: this.show || !this.parent.animation
      }],
