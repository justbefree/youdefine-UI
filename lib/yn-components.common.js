...
__webpack_require__.d(__webpack_exports__, "YnInfiniteList", function() { return /* reexport */ src_infinite_list; });
__webpack_require__.d(__webpack_exports__, "YnInfiniteListItem", function() { return /* reexport */ src_infinite_list_item; });
...
var getConfig = function getConfig(props) {
  return Object({"NODE_ENV":"production","VUE_APP_PREFIX":"yn","VUE_APP_VERSION":"0.6.13","BASE_URL":"/youdefine-UI/"})[props] || "";
};
...
// CONCATENATED MODULE: ./src/infinite-list/infinite-list.js
...
var infinite_list_VALID_CHILD_COMPONENT = "infinite-list-item";
/* harmony default export */ var infinite_list = (component_defineComponent({
  name: "InfiniteList",
  props: {
    dataList: {
      type: Array,
  ...
  methods: {
    ...
    getSlots: function getSlots() {
      var prefix = this.VUE_APP_PREFIX;
      var validChildComponent = infinite_list_VALID_CHILD_COMPONENT;

      if (prefix !== "") {
        validChildComponent = "".concat(prefix, "-").concat(infinite_list_VALID_CHILD_COMPONENT);
      }
  ...
  render: function render(h) {
    return h("div", {
      class: ["yn-infinite-list"]
    }, [h(component_genComponentName("flex"), {
      props: {
        flexDirection: "column"
      }
    }, Array.apply(null, this.stackList).map(function (item, key) {
      return h(component_genComponentName("flex-item"), {
        key: key
      }, [item]);
    }))]);
...
// CONCATENATED MODULE: ./src/infinite-list/index.js
/*
 * @Author: Just be free
 * @Date:   2020-11-11 10:03:15
 * @Last Modified by:   Just be free
 * @Last Modified time: 2020-11-11 10:04:47
 * @E-mail: justbefree@126.com
 */


/* harmony default export */ var src_infinite_list = (component_install(infinite_list));
// CONCATENATED MODULE: ./src/infinite-list-item/infinite-list-item.js
 ...
 * @Last Modified by:   Just be free
 * @Last Modified time: 2020-11-11 14:15:05
 * @E-mail: justbefree@126.com
 */


/* harmony default export */ var infinite_list_item = (component_defineComponent({
...
// CONCATENATED MODULE: ./src/infinite-list-item/index.js
/*
 * @Author: Just be free
 * @Date:   2020-11-11 10:27:48
 * @Last Modified by:   Just be free
 * @Last Modified time: 2020-11-11 10:28:23
 * @E-mail: justbefree@126.com
 */


/* harmony default export */ var src_infinite_list_item = (component_install(infinite_list_item));
...
var components = [src_action_sheet, src_button, src_calendar, src_checkbox, src_city_picker, src_counter, src_date_picker, src_dialog, src_dropdown_menu, src_dropdown_menu_item, src_field, src_field_group, src_flex, src_flex_item, src_iconfont, src_indicator, src_infinite_list, src_infinite_list_item, src_layout, src_picker, src_picky_stepper, src_popup, src_pull_refresh, src_radiobox, src_skeleton, src_slider, src_spin, src_sticky, src_submit_action, src_submit_action_popup_content, src_submit_action_value, src_swipe, src_swipe_item, src_tab_item, src_tabs, src_toast];
