...
var getConfig = function getConfig(props) {
  return Object({"NODE_ENV":"production","VUE_APP_PREFIX":"yn","VUE_APP_VERSION":"1.5.1","BASE_URL":"/youdefine-UI/"})[props] || "";
};
 ...
 * @Last Modified by:   Just be free
 * @Last Modified time: 2021-04-07 17:39:32
 */
      ...
      if (this.cachedAlphaBeta[e] && this.cachedAlphaBeta[e].length) {
        ...
        if (utils_isPromise(promise)) {
          promise.then(function (res) {
            ...
            if (data && data.length) {
              _this5.cachedAlphaBeta[e] = data; // this.alphaBetaCities = data;
