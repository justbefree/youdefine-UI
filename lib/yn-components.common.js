...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".yn-spin-rotate{width:50px;height:50px;display:inline-block;overflow:hidden}.yn-spin-rotate .rotate-leaf-wapper{width:100%;height:100%;position:relative;transform:translateZ(0) scale(1);-webkit-backface-visibility:hidden;backface-visibility:hidden;transform-origin:0 0}.yn-spin-rotate .rotate-leaf-wapper .rotate-leaf{box-sizing:content-box;position:absolute;width:20%;height:20%;border-radius:50%;transform:translate(40%,40%) scale(1);background:#007aff;-webkit-animation:rotate-leaf-wapper 1.13636364s cubic-bezier(0,.5,.5,1) infinite;animation:rotate-leaf-wapper 1.13636364s cubic-bezier(0,.5,.5,1) infinite}.yn-spin-rotate .rotate-leaf-wapper .rotate-leaf-1{background:#58a8ff;-webkit-animation:rotate2 .28409091s cubic-bezier(0,.5,.5,1) infinite,rotate3 1.13636364s step-start infinite;animation:rotate2 .28409091s cubic-bezier(0,.5,.5,1) infinite,rotate3 1.13636364s step-start infinite}.yn-spin-rotate .rotate-leaf-wapper .rotate-leaf-2{-webkit-animation-delay:-.28409091s;animation-delay:-.28409091s;background:#007aff}.yn-spin-rotate .rotate-leaf-wapper .rotate-leaf-3{-webkit-animation-delay:-.56818182s;animation-delay:-.56818182s;background:#58a8ff}.yn-spin-rotate .rotate-leaf-wapper .rotate-leaf-4{-webkit-animation-delay:-.85227273s;animation-delay:-.85227273s;background:#cde5ff}.yn-spin-rotate .rotate-leaf-wapper .rotate-leaf-5{-webkit-animation-delay:-1.13636364s;animation-delay:-1.13636364s;background:#58a8ff}@-webkit-keyframes rotate-leaf-wapper{0%{transform:translate(3px,20px) scale(0)}25%{transform:translate(3px,20px) scale(0)}50%{transform:translate(3px,20px) scale(1)}75%{transform:translate(20px,20px) scale(1)}to{transform:translate(37px,20px) scale(1)}}@keyframes rotate-leaf-wapper{0%{transform:translate(3px,20px) scale(0)}25%{transform:translate(3px,20px) scale(0)}50%{transform:translate(3px,20px) scale(1)}75%{transform:translate(20px,20px) scale(1)}to{transform:translate(37px,20px) scale(1)}}@-webkit-keyframes rotate2{0%{transform:translate(37px,20px) scale(1)}to{transform:translate(37px,20px) scale(0)}}@keyframes rotate2{0%{transform:translate(37px,20px) scale(1)}to{transform:translate(37px,20px) scale(0)}}@-webkit-keyframes rotate3{0%{background:#007aff}25%{background:#58a8ff}50%{background:#cde5ff}75%{background:#58a8ff}to{background:#007aff}}@keyframes rotate3{0%{background:#007aff}25%{background:#58a8ff}50%{background:#cde5ff}75%{background:#58a8ff}to{background:#007aff}}", ""]);
// Exports
module.exports = exports;
...
var getConfig = function getConfig(props) {
  return Object({"NODE_ENV":"production","VUE_APP_PREFIX":"yn","VUE_APP_VERSION":"0.4.2","BASE_URL":""})[props] || "";
};
