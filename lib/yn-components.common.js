...
var getConfig = function getConfig(props) {
  return Object({"NODE_ENV":"production","VUE_APP_PREFIX":"yn","VUE_APP_VERSION":"0.9.5","BASE_URL":"/youdefine-UI/"})[props] || "";
};
...
/* harmony default export */ var picker = (component_defineComponent({
  ...
  methods: {
    ...
    getColumns: function getColumns(h) {
      ...
      var columns = [];
      this.computedColumn.forEach(function (column, key) {
        var columnsProp = Array.isArray(column.value) ? column.value : column;
